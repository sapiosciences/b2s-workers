...
/**
 * Automatically generated class for: Sponsor
 */
@ExemplarDataTypeModel(dataTypeName="C_Sponsor")
public class C_SponsorModel extends AbstractRecordModelWrapper {

	/**
	 * The name of the Data Type this class represents
	 */
	public static final String DATA_TYPE_NAME = "C_Sponsor";
	...
	protected C_SponsorModel(RecordModel backingModel) {
		super(backingModel);
	}
